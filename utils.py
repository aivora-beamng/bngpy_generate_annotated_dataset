...
SPAWN_POINTS = dict(italy={
    'village_mountain': ((251.443667, -893.291338, 246.567589), (0, 0, 0.793353388, 0.608761367)),
...
def unjam_traffic(beamng: BeamNGpy, ego: Vehicle, map: str, spawnpoint_iter: cycle[str], jammed: bool) -> None:
    beamng.traffic.reset()
